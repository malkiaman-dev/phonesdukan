...
$metaDescription = "Shop the best Bluetooth speakers at Phones Dukan! Find top brands like Sony and Xiaomi at unbeatable prices in Pakistan. Elevate your sound experience!";
...
// Fetch products that belong to "bluetooth-speakers" category
...
<div class="speakers-section">
    <div class="speakers-price-info">
        <h1><span>Bluetooth Speakers</span> Prices in Pakistan <?php echo date('F Y'); ?></h1>
    </div>
</div>
<?php include_once __DIR__ . '/ad/feed1.php'; ?>
<div class="product-section">
    <div class="category-header">
        <h2>Bluetooth <span>Speakers</span></h2>
    </div>
    ...
    <div class="pagination">
        <?php
        // Count total products in the 'bluetooth-speakers' category
