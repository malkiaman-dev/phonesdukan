...
$metaDescription = "Find unbeatable smartphone deals at Phones Dukan! Shop top brands like Samsung and Apple, all at the lowest mobile prices in Pakistan. Don't miss out!";
...
// Fetch products that belong to "mobile-accessories" category
...
<div class="accessories-section">
    <div class="accessories-price-info">
        <h1><span>Mobile Accessories</span> Prices in Pakistan - <?php echo date('F Y'); ?></h1>
    </div>
</div>
<?php include_once __DIR__ . '/ad/feed1.php'; ?>
<div class="product-section">
    <div class="category-header">
        <h2>Mobile <span>Accessories</span></h2>
    </div>
    ...
    <div class="pagination">
        <?php
        // Count total products in the 'mobile-accessories' category
