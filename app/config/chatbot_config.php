...
// API key lives in chatbot_config.local.php (gitignored) or CHATBOT_API_KEY env var.

$chatbotLocalConfig = __DIR__ . '/chatbot_config.local.php';
if (is_readable($chatbotLocalConfig)) {
    require_once $chatbotLocalConfig;
}
