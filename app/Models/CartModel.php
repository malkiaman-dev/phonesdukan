...
class CartModel {
    ...
    public function addToCart($product_id, $quantity, $userId, $sessionId, $unit_price, $attribute_value = null, $payment_method = 'cod') {
        $query = "SELECT cart_id, quantity FROM cart WHERE product_id = :product_id AND (user_id = :user_id OR session_id = :session_id)";
        $stmt = $this->db->prepare($query);
        $stmt->bindParam(':product_id', $product_id, PDO::PARAM_INT);
        ...
        if ($cartItem) {
            $updateQuery = "UPDATE cart SET quantity = :quantity, unit_price = :unit_price, attribute_value = :attribute_value, payment_method = :payment_method WHERE cart_id = :cart_id";
            ...
            $insertQuery = "INSERT INTO cart (product_id, quantity, user_id, session_id, unit_price, attribute_value, payment_method) 
                            VALUES (:product_id, :quantity, :user_id, :session_id, :unit_price, :attribute_value, :payment_method)";
