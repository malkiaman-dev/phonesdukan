(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var faqItems = Array.from(document.querySelectorAll('.pb-faq-item'));
        if (!faqItems.length) return;

        function closeItem(item) {
            var btn = item.querySelector('.pb-faq-question');
            var answer = item.querySelector('.pb-faq-answer');
    ...
    /* ── Power bank ads: CSS-first + JS fallback ────────── */
    (function () {
