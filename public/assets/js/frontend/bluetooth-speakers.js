(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var faqItems = Array.from(document.querySelectorAll('.bs-faq-item'));
        if (!faqItems.length) return;

        function closeItem(item) {
            var btn = item.querySelector('.bs-faq-question');
            var answer = item.querySelector('.bs-faq-answer');
    ...
    /* ── Speaker ads: CSS-first + JS fallback ───────────── */
    (function () {
